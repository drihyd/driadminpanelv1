...
/*Sitemap.xml*/
Route::get('sitemap.xml',[SitemapController::class,'load_xml_data'])->name('sitemap.xml');
Route::get('sitemap.xml/category',[SitemapController::class,'load_xml_category_data'])->name('sitemap..category.xml');
...
Route::group( ['prefix' => 'admin','middleware' => 'admin'],function(){
	...
	Route::get('updateproductprices/{type?}', [ImportExportController::class,'daily_update_skus_prices'])->name('update.sku.prices.daily');
	...
	Route::any('bulk-images-upload', [BulkImagesUploadController::class, 'dropzone'])->name('products.upload.images');
...
Route::get('generate-giftcard-voucher', [RazorpayController::class,'generate_giftcard_voucher'])->name('generate.giftcard.voucher');
...
Route::get('mywishlist/delete/{id}', [MyAccountController::class,'delete_wishlist'])->name('wishlist.delete');
...
Route::get('/comingsoon', [ContentPagesController::class,'comingsoon']);
...
Route::get('admin/support_leads/delete/{id}',[FAQsController::class,'delete_support_leads']);
...
Route::get('admin/newsletters/delete/{id}',[NewsletterController::class,'delete_newsletter'])->middleware('admin');
...
/*Admin Home Content*/
Route::resource('admin/homecontent', HomecontentController::class)->middleware('admin');
Route::get('admin/homecontent/create',[HomecontentController::class,'create_homecontent'])->middleware('admin');
Route::post('admin/homecontent/store',[HomecontentController::class,'store_homecontent'])->middleware('admin');
Route::get('admin/homecontent/edit/{id}',[HomecontentController::class,'edit_homecontent'])->middleware('admin');
Route::post('admin/homecontent/update',[HomecontentController::class,'update_homecontent'])->middleware('admin');
Route::get('admin/homecontent/delete/{id}',[HomecontentController::class,'delete_homecontent'])->middleware('admin');
...
Route::post('dropzone/store', [BulkImagesUploadController::class, 'dropzoneStore'])->name('dropzone.store');
...
Route::get('admin/contacts/delete/{id}',[ContactsController::class,'delete_contacts'])->middleware('admin')->middleware('admin');
...
/* Gold Prices*/
Route::resource('admin/goldprices', GoldPriceController::class)->middleware('admin');
Route::get('admin/goldprices/create',[GoldPriceController::class,'create_goldprices'])->middleware('admin');
Route::post('admin/goldprices/store',[GoldPriceController::class,'store_goldprices'])->middleware('admin');
Route::get('admin/goldprices/edit/{id}',[GoldPriceController::class,'edit_goldprices'])->middleware('admin');
Route::post('admin/goldprices/update',[GoldPriceController::class,'update_goldprices'])->middleware('admin');
Route::get('admin/goldprices/delete/{id}',[GoldPriceController::class,'delete_goldprices'])->middleware('admin');
