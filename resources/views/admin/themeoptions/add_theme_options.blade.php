...
@endif
        ...
        @if(isset($theme_options_data->favicon) && !empty($theme_options_data->favicon))
          ...
          <div class="form-group">
            <label>Facebook Call to URL</label>
            <input type="url" name="facebook_url" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->facebook_url??''}}@else{{ old('facebook_url') }}@endif" >
          </div>
          <div class="form-group">
            <label>Instagram Call to URL</label>
            <input type="url" name="instagram_url" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->instagram_url??''}}@else{{ old('instagram_url') }}@endif" >
          </div>
          <div class="form-group">
            <label>Twitter Call to URL</label>
            <input type="url" name="twitter_url" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->twitter_url??''}}@else{{ old('twitter_url') }}@endif" >
          </div>
          <div class="form-group">
            <label>Pinterest Call to URL</label>
            <input type="url" name="pinterest_url" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->pinterest_url??''}}@else{{ old('pinterest_url') }}@endif">
          </div>
           <div class="form-group">
            <label>Youtube Call to URL</label>
            <input type="url" name="youtube_url" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->youtube_url??''}}@else{{ old('youtube_url') }}@endif" >
          </div>
		</div>
		<div class="col-sm-5">
          ...
          <div class="form-group">
            <label>GST NO on Invoice</label>
            <input type="text" name="gst_no_invoice" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->gst_no_invoice??''}}@else{{ old('gst_no_invoice') }}@endif">
          </div>
          <div class="form-group">
		  ...
		  <div class="form-group">
            <label>Pan number on Invoice<span style="color: red">(Optional)</span></label>
            <input type="text" name="pan_no_invoice" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->pan_no_invoice??''}}@else{{ old('pan_no_invoice') }}@endif" required="">
          </div>
           <div class="form-group">
          ...
          <div class="form-group">
            <label>Shop on Button Name</label>
            <input type="text" name="shop_on_button" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->shop_on_button??''}}@else{{ old('shop_on_button') }}@endif" >
          </div>
          <div class="form-group">
            <label>Shop on Button Url</label>
            <input type="url" name="shop_on_url" id="title" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->shop_on_url??''}}@else{{ old('shop_on_url') }}@endif" >
          </div>
		  
		  
		     <div class="form-group">
            <label>Contact Number</label>
            <input type="text" name="contact_phone" id="contact_phone" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->contact_phone??''}}@else{{ old('contact_phone') }}@endif" >
          </div>
		  
		          <div class="form-group">
            <label>Contact Email</label>
            <input type="email" name="contact_email" id="contact_email" class="form-control" value="@if(isset($theme_options_data->id)){{$theme_options_data->contact_email??''}}@else{{ old('contact_email') }}@endif" >
          </div>
