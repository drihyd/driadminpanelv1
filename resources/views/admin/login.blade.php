                                    ...
                                    <form action="{{route('adminlogin.verification')}}" method="post">
                                       @csrf 
                                        <div class="form-head text-center mb-4">
                                            ...
                                            <a href="#" class="logo"><img src="{{URL::to('assets/uploads/'.$theme_options_data->header_logo??'')}}" class="img-fluid" alt="logo" width="200px"></a>
                                      
                                        </div>                                        
                                        <h3 class="text-danger my-4 text-center">Administrator Login</h3>
