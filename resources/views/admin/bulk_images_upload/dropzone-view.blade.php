...
<div class="input-group">
	...
	<strong>product_code_1.jpg</strong> (This pattern image showing on product cart panel and dimension is: 500*500)<br>
	<strong>product_code_2.jpg,product_code_3.jpg</strong> etc (This pattern name images showing on single product page like gallery and dimension is: 1000*1000)<br>
 ...
 ajax:{
    ...
    var id = $(this).attr('data-id');
        if (confirm("Are you sure delete this product image?") == true) {
          ...
          $.ajax({
            type:"POST",
            url: "{{ url('admin/bulk_images_upload/delete') }}",
