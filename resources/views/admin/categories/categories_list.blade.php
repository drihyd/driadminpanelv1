...
@include('admin.pagetitle')
    ...
    <div class="float-right">
    	<a href="{{ url('admin/categories/create') }}" class="btn btn-brand">+ Add Parent/Child Category</a>
      <!-- <a href="" class="btn btn-brand">+ Add Child Category</a> -->
		...
		<a href="{{url('admin/categories/edit/'.Crypt::encryptString($category->id))}}" class="edit mr-2" title="Edit" >
			    ...
			    <strong>{{ucwords($category->name) }}</strong>
						...
						@endif
						 ...
						 <td><a href="{{route('products.upload.images',['cat' =>Crypt::encryptString($category->id)])}}" title="Upload Images" alt="Upload Images"><i class="fas fa-image"></i></a></td>
                          ...
                          <td width="10%">
                          	...
                          	<a href="{{url('admin/categories/edit/'.Crypt::encryptString($category->id))}}" class="edit mr-2" title="Edit" ><i class="fas fa-pen"></i></a>
                            <a href="{{url('admin/categories/delete/'.$category->id)}}" class="delete" title="Delete" onclick="return confirm('Are you sure to delete this?')"><i class="fas fa-trash-alt"></i></a>
                      ...
                      <tr>
						  ...
						  <td>  </td>
						   <td>  </td>
                          <td width="10%">
                            <a href="{{url('admin/categories/edit/'.Crypt::encryptString($parentfilter->id))}}" class="edit mr-2" title="Edit" ><i class="fas fa-pen"></i></a>
                            <a href="{{url('admin/categories/delete/'.$parentfilter->id)}}" class="delete" title="Delete" onclick="return confirm('Are you sure to delete this?')"><i class="fas fa-trash-alt"></i></a>
                            </a>
