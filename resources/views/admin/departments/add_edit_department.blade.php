...
<form id="crudTable" action="{{url('admin/departments/update')}}" method="POST"  enctype="multipart/form-data">
<input type="hidden" name="id" value="{{$departments_data->id}}">
@else
<form id="crudTable" action="{{url('admin/departments/store')}}" method="POST"  enctype="multipart/form-data" data-parsley-validate>
@endif  
      @csrf
      <div class="row">
        <div class="col-md-5">
      ...
      <a href="{{url('admin/departments')}}" class="btn btn-info">Back</a>
    </div>
    <div class="col-md-5">
